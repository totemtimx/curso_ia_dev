...
public class MessageProcessorService : IMessageProcessorService
{
    ...
    public MessageProcessorService(IGeminiService geminiService, IFileService fileService)
    {
    ...
    public async Task<MessageResponse> ProcessMessageAsync(MessageRequest request)
    {
        try
        {
            // Clasificar el mensaje usando Gemini
            var category = await _geminiService.ClassifyMessageAsync(request.Message);
            ...
            switch (category)
            {
                case MessageCategory.UserCreation:
                    ...
                    var userValidation = await _geminiService.ValidateUserCreationInfoAsync(request.Message);
                    ...
                    else
                    {
                        ...
                        var userName = await _geminiService.ExtractUserNameAsync(request.Message);
                ...
                case MessageCategory.ProductInformation:
                    ...
                    var productValidation = await _geminiService.ValidateProductInfoAsync(request.Message);
